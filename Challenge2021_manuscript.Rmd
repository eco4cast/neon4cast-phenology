...
allMeans$CRPS <- as.numeric(allMeans$CRPS)
allMeans$CRPS_SD <- as.numeric(allMeans$CRPS_SD)
...
allAnomalies$Anomaly <- as.numeric(allAnomalies$Anomaly)
allAnomalies$Anomaly_SD <- as.numeric(allAnomalies$Anomaly_SD)
allAnomalies$siteFullName <- site_full_names[match(allAnomalies$Site,names(site_full_names))]


jpeg(file=paste0(figureDirectory,"averageCRPSvalues_transitionDates.jpeg"),width = 9, height = 5, units = "in",res=1000)
...
jpeg(file=paste0(figureDirectory,"transitionDate_anomalies.jpeg"),width = 9, height = 5, units = "in",res=1000)
...
jpeg(file=paste0(figureDirectory,"sitePredictability_LinearRegressions.jpeg"),width = 7, height = 4, units = "in",res=1000)
par(mai=c(0.6,0.6,0.1,0.1))
par(mfrow=c(2,3))

siteLM = lm(Estimate ~ day15,beta.site)
plot(beta.site$day15,beta.site$Estimate,xlab="DOY of 15% Greenup",ylab="Site Predictability",pch=20)
abline(siteLM)
sm <- summary(siteLM)
text(80,0.0078,paste('p-value:',round(sm$coefficients[2,4],digits=3)),pos=4)
text(80,0.007,paste('R2:',round(sm$r.squared,digits=3)),pos=4)

siteLM = lm(Estimate ~ day50,beta.site)
plot(beta.site$day50,beta.site$Estimate,xlab="DOY of 50% Greenup",ylab="",pch=20)
abline(siteLM)
sm <- summary(siteLM)
text(87,0.0078,paste('p-value:',round(sm$coefficients[2,4],digits=3)),pos=4)
text(87,0.007,paste('R2:',round(sm$r.squared,digits=3)),pos=4)

siteLM = lm(Estimate ~ day85,beta.site)
plot(beta.site$day85,beta.site$Estimate,xlab="DOY of 85% Greenup",ylab="",pch=20)
abline(siteLM)
sm <- summary(siteLM)
text(93,0.0078,paste('p-value:',round(sm$coefficients[2,4],digits=3)),pos=4)
text(93,0.007,paste('R2:',round(sm$r.squared,digits=3)),pos=4)

siteLM = lm(Estimate ~ anomaly15,beta.site)
plot(beta.site$anomaly15,beta.site$Estimate,xlab="DOY Anomaly of 15% Greenup",ylab="Site Predictability",pch=20)
abline(siteLM)
sm <- summary(siteLM)
text(-6,0.004,paste('p-value:',round(sm$coefficients[2,4],digits=3)),pos=4)
text(-6,0.0032,paste('R2:',round(sm$r.squared,digits=3)),pos=4)

siteLM = lm(Estimate ~ anomaly50,beta.site)
plot(beta.site$anomaly50,beta.site$Estimate,xlab="DOY Anomaly of 50% Greenup",ylab="",pch=20)
abline(siteLM)
sm <- summary(siteLM)
text(-6,0.004,paste('p-value:',round(sm$coefficients[2,4],digits=3)),pos=4)
text(-6,0.0032,paste('R2:',round(sm$r.squared,digits=3)),pos=4)
...
plot(beta.site$anomaly85,beta.site$Estimate,xlab="DOY Anomaly of 85% Greenup",ylab="",pch=20)
abline(siteLM)
sm <- summary(siteLM)
text(-6.5,0.004,paste('p-value:',round(sm$coefficients[2,4],digits=3)),pos=4)
text(-6.5,0.0032,paste('R2:',round(sm$r.squared,digits=3)),pos=4)
