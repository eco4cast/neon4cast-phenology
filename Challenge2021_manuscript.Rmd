...
```{r}
## play with https://github.com/eco4cast/neon4cast/blob/main/notebook/multi_team_plot.R and see what's useful
```


```{r,echo=FALSE}
## grab and load forecasts
## update to https://data.ecoforecast.org/minio/analysis/combined_forecasts_scores.csv.gz
filename = "phenology_combined_forecasts.csv"
filename = "combined_forecasts_scores.csv.gz"
...
#allData = readr::read_csv("phenology-targets.csv.gz")
```
