...
meta <- as.data.frame(matrix(NA,n_teams,12))
row.names(meta) <- teams
colnames(meta) <- c("type","drivers","ndrivers","initial_conditions","ninitial_conditions","parameters","nparameters","process_error","nprocess_error","obs_error","random_effects","nrandom_effects")
for(i in seq_along(fname)){
