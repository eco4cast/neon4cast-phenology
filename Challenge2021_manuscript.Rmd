...
plot(challengeDays[gccForecastsYes[,tm]],rep(tm,length(challengeDays))[gccForecastsYes[,tm]],pch=20,
     xlab="Date",ylab="",ylim=c(0,n_teams),bty="n",yaxt="n",main="a) Forecasted Days",font.main=1)
...
gccForecastsYes <- gccForecastsYes[,teamOrder]
plot(challengeDays[gccForecastsYes[,tm]],rep(tm,length(challengeDays))[gccForecastsYes[,tm]],pch=20,
     xlab="Date",ylab="",ylim=c(0,n_teams),bty="n",yaxt="n",main="b) Submission Days",xlim=range(challengeDays),font.main=1)
