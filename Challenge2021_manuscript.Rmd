...
#' @param statistic Desired statistic ("CRPS", "bias" or "sd"). 
...
plotStatisticsOverTime(highlightTms=NA,statistic="sd",ylim=c(0,0.15),site_number=1,gcc_forecast_subset=gcc_forecast_subset)
