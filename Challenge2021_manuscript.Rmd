...
```{r, echo=FALSE}
## Lead Time Figures
plotStatisticsOverTime <- function(highlightTms=NA,statistic,ylim=c(0,1)){
...
plotStatisticsOverTime(highlightTms=NA,statistic="bias",ylim=c(-0.1,0.15))
plotStatisticsOverTime(highlightTms=NA,statistic="CRPS",ylim=c(0,0.15))
plotStatisticsOverTime(highlightTms=NA,statistic="MAE",ylim=c(0,0.15))
